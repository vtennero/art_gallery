...
/**
 * Main gallery component with horizontal scrolling, zoom functionality, and sharing
 * Displays all paintings in a browsable interface with navigation controls
 */
export default function MainGallery({ images, isTransitioning }: MainGalleryProps) {
  ...
  return (
    <>
      {/* White background overlay during transition */}
      {isTransitioning && (
        <div 
          style={{
            position: 'fixed',
      ...
      <div 
        className="min-h-screen w-full md:h-screen md:overflow-hidden bg-gray-50"
        style={{
